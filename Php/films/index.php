...
<body>
    ...
    <div class="row d-flex justify-content-center">
        ...
        if (isset($_POST["unFilm"])) {
            foreach (recupereUneCarte() as $carte) {
    ...
    <form method="POST">
        <button class="btn btn-primary" type="submit" name="unFilm"> Afficher 1 film </button>
        <button class="btn btn-primary" type="submit" name="toutLesFilms"> Afficher Tous les films </button>
